export default {
    'general': {
        'alert': 'แจ้งเตือน',
        'close_App': 'คุณต้องการปิด แอป ใช่ไหม?',
        'close': 'ปิด',
        'canceled': 'ยกเลิก',
        'yes': 'ใช่',
    ...
    'FoodDiary': {
        ...
        'number': 'จำนวน',
        'calorie': 'แคลอรี่',
        'want_Delete': 'คุณต้องการลบ',
        'right': 'ใช่ไหม?',
        'clock': 'น.',
        'date': 'วันที่',
        'energy_today': 'พลังงานที่ได้รับในวันนี้',
        'energy_per_day': 'พลังงานที่ต้องการต่อวัน',
        'over': 'เกิน',
        'surplus': 'เหลือ',
        'should_Add': 'ควรเพิ่ม',
        'fit': 'พอดี',
        'should_Reduce': 'ควรลด',
        'Dialog': {
            'please_Information': 'กรุณากรอกข้อมูลส่วนตัวของคุณ',
            'sex': 'เพศ',
            'male': 'ชาย',
            'female': 'หญิง',
            'Age': 'อายุ',
    ...
    'MenuFood': {
        'title': 'รายการอาหาร',
        'all': 'ทั้งหมด',
        'fill_Food_Name': 'ใส่ชื่ออาหารที่ต้องการค้นหา',
        'number_Found': ' จำนวนที่พบ ',
        'list': ' รายการ',
        'can_one': 'สามารถเลือกได้แค่ 1 ประเภทเท่านั้น',
        'foodDetail': {
            'title': 'รายละเอียดอาหาร',
            'save_Diary': 'บันทึกลงไดอารี่',
            'save_Searching': 'บันทึกและค้นหาต่อ',
            'amountcalories_compared': 'ปริมาณแคลลอรี่เปรียบเทียบต่อ  ',
            'imgGit': {
                'walk': 'เดิน',
                'run': 'วิ่ง',
                'spin': 'ปั่น',
    ...
    'User': {
        ...
        'username_characters':'ชื่อผู้ใช้ต้องมากกว่า 4 ตัวขึ้นไป',
        'correct_email': 'กรุณากรอก อีเมล ให้ถูกต้อง',
        'complete_Subscription': 'สมัครสมาชิกเสร็จสิ้น',
        'login': 'เข้าสู่ระบบ',
